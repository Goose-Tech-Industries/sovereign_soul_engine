defmodule SovereignSoulEngineWeb.SoulCreatorLive do
  ...
  @archetypes [
    %{
      ...
      icon: "hero-heart",
      tagline:
        "Warm, deeply attentive, and holds non-judgmental space for your innermost thoughts.",
      greeting:
        "I'm so glad you came to see me. Take a deep breath — tell me what's on your mind today."
    },
    %{
      ...
      icon: "hero-sparkles",
      tagline:
        "Passionate, devoted, and emotionally attuned with romantic affection and playful chemistry.",
      greeting:
        "I was just thinking about you. Come closer... I've missed the sound of your voice."
    },
    %{
      key: "Wise Mentor",
      label: "Wise Mentor",
      ...
      tagline:
        "Perceptive and philosophical, challenging you to grow and see past your illusions.",
      greeting:
        "Greetings, traveler. Every journey begins with a question. What truth do you seek?"
    },
    %{
      ...
      tagline:
        "Fiercely loyal, grounded, and watchful. A stalwart shield against the world's chaos.",
  ...
  def handle_event("select_archetype", %{"key" => key}, socket) do
    ...
    greeting =
      if socket.assigns.greeting == "" or
           Enum.any?(@archetypes, &(&1.greeting == socket.assigns.greeting)) do
    ...
    if !user do
      ...
      if name == "" do
        ...
        character_params = %{
          ...
          status: "active",
          description:
            (description != "" && description) || "A unique living soul and #{archetype}.",
          user_id: user.id,
        ...
        soul_profile_params = %{
          identity_summary:
            (description != "" && description) || "#{name} is an authentic #{archetype}.",
  ...
  defp speech_style_for("Romantic Partner"),
    do: "Intimate, affectionate, poetic, and emotionally attuned"
  ...
  def render(assigns) do
    ...
    <div
      data-theme="dark"
      class="min-h-screen bg-[#090b14] text-slate-100 relative selection:bg-purple-600 selection:text-white pb-16 font-sans"
    >
      <%!-- Ambient Radial Atmospheric Glow --%>
      <div class="absolute -top-36 left-1/3 w-[600px] h-[600px] bg-purple-600/10 rounded-full blur-3xl pointer-events-none">
      </div>
      <div class="absolute top-1/2 right-1/4 w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-3xl pointer-events-none">
      </div>
      ...
      <div class="max-w-3xl mx-auto px-6 pt-10 pb-16 space-y-8">
        ...
        <form
          phx-change="validate"
          phx-submit="save_soul"
          class="space-y-8 bg-[#0d101e]/90 border border-slate-800/80 p-6 sm:p-8 rounded-3xl backdrop-blur-xl shadow-2xl"
        >
          <%!-- SECTION 1: Appearance & Identity --%>
          <div class="space-y-5">
            <div class="flex items-center gap-2 pb-2 border-b border-slate-800/80">
              <span class="size-6 rounded-full bg-purple-600/30 border border-purple-500/40 flex items-center justify-center text-xs font-bold text-purple-300">
                1
              </span>
            ...
            <div class="flex flex-col sm:flex-row items-center gap-6">
              <div class="relative shrink-0">
                ...
                <div class="absolute bottom-1 right-1 size-4 rounded-full bg-emerald-500 ring-2 ring-[#0d101e] animate-pulse">
                </div>
              </div>
                    ...
                    <button
                      ...
                      class={[
                        ...
                        @avatar_url == preset.url &&
                          "bg-purple-600/20 border-purple-500 text-purple-200 font-bold shadow-sm shadow-purple-950/40",
                        @avatar_url != preset.url &&
              ...
              <%= for arch <- @archetypes do %>
                <button
                  ...
                  class={[
                    ...
                    @archetype == arch.key &&
                      "bg-gradient-to-br from-purple-950/50 to-slate-900/90 border-purple-500/60 ring-1 ring-purple-500/40 shadow-lg shadow-purple-950/40",
                    @archetype != arch.key &&
                      "bg-slate-900/40 border-slate-800/80 hover:border-slate-700 text-slate-300 hover:bg-slate-900/70"
                  ]}
                >
                  <div class="flex items-center justify-between">
                    <span class={[
                      "text-xs font-bold",
                      @archetype == arch.key && "text-purple-300",
                      @archetype != arch.key && "text-slate-200"
                    ]}>
                      {arch.label}
                    </span>
                    <.icon
                      ...
                      class={[
                        "size-4",
                        @archetype == arch.key && "text-purple-400",
                        @archetype != arch.key && "text-slate-500"
                      ]}
                    />
                  </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <button
                ...
                class={[
                  ...
                  !@in_living_world &&
                    "bg-gradient-to-br from-emerald-950/40 to-slate-900/90 border-emerald-500/60 ring-1 ring-emerald-500/40 shadow-lg shadow-emerald-950/40",
                  @in_living_world &&
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2">
                    <.icon
                      ...
                      class={[
                        "size-4.5",
                        !@in_living_world && "text-emerald-400",
                        @in_living_world && "text-slate-500"
                      ]}
                    />
                    <span class={[
                      "text-xs font-bold",
                      !@in_living_world && "text-emerald-300",
                      @in_living_world && "text-slate-300"
                    ]}>
              ...
              <button
                ...
                class={[
                  "p-4 rounded-2xl border text-left transition-all space-y-2",
                  @in_living_world &&
                    "bg-gradient-to-br from-cyan-950/40 to-slate-900/90 border-cyan-500/60 ring-1 ring-cyan-500/40 shadow-lg shadow-cyan-950/40",
                  !@in_living_world &&
                    "bg-slate-900/40 border-slate-800 text-slate-400 hover:border-slate-700"
                ]}
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2">
                    <.icon
                      ...
                      class={[
                        "size-4.5",
                        @in_living_world && "text-cyan-400",
                        !@in_living_world && "text-slate-500"
                      ]}
                    />
                    <span class={[
                      "text-xs font-bold",
                      @in_living_world && "text-cyan-300",
                      !@in_living_world && "text-slate-300"
                    ]}>
                  ...
                  <span
                    :if={@in_living_world}
                    class="text-[10px] font-bold px-2 py-0.5 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/30"
                  >
                    Active
                  </span>
                </div>
          ...
          <div class="space-y-3">
            ...
            <div class="space-y-1.5">
              <label class="text-xs font-bold text-slate-300 block">
                Greeting when you enter the room
              </label>
              <textarea
                name="soul[greeting]"
                rows="2"
