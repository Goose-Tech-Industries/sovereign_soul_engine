    ...
    <div data-theme="dark" class="min-h-screen bg-slate-950 text-slate-200 py-12 px-6">
      <div class="max-w-4xl mx-auto space-y-8">
        <div class="border-b border-slate-800 pb-6 flex items-center justify-between">
          ...
          <span class="badge badge-primary font-mono text-xs uppercase px-3 py-1">
            Commercial Terms
          </span>
        </div>
        ...
        <div class="prose prose-invert max-w-none text-xs leading-relaxed space-y-6 text-slate-300">
          ...
          <section class="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-2">
            <h2 class="text-sm font-bold text-white uppercase tracking-wider text-rose-400">
              2. Age Requirement & Informed Consent (18+)
            </h2>
            <p>
          ...
          <section class="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-2">
            <h2 class="text-sm font-bold text-white uppercase tracking-wider">
              3. Artificial Intelligence & Non-Therapy Disclaimer
            </h2>
            <p>
              Sovereign Souls are autonomous, generative software entities powered by neural language models and state machines.
              <strong>
                They are not real human beings, licensed medical doctors, psychologists, or mental health therapists.
              </strong>
          ...
          <section class="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-2">
            ...
            <p>
              ...
              New accounts receive fifteen (15) complimentary trial messages. Once this allocation is exhausted, access to continued conversation requires an active subscription pass.
            </p>
            <p>
            ...
            <ul class="list-disc pl-5 space-y-1">
              <li>
                <strong>Sovereign Companion Pass ($14.99 / month):</strong>
                Unlimited real-time messages, custom companion creation, voice intercom, biometric HUD telemetry, and private memory vaults.
              </li>
              <li>
                <strong>Sovereign Archon ($19.99 / month):</strong>
                All Companion features plus 18+ Uncensored cinema persona depth, wearable haptics, and unlimited private rooms.
              </li>
            </ul>
            <p>
              <strong>Payment Processing:</strong>
              Billing is processed securely by Stripe. Your subscription will automatically renew each month unless canceled prior to the renewal date.
            </p>
            <p>
        ...
        <div class="border-t border-slate-800 pt-6 flex items-center justify-between text-xs text-slate-500">
          ...
          <.link navigate={~p"/privacy"} class="text-primary hover:underline font-semibold">
            Privacy Policy →
          </.link>
        </div>
      </div>
