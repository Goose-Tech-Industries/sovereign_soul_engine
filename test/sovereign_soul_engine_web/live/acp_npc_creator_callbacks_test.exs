defmodule SovereignSoulEngineWeb.AcpNpcCreatorCallbacksTest do
  ...
  test "creator drafts cover beliefs, triggers, boundaries, motivations, and arcs" do
    ...
    callbacks = [
      ...
      {"update_belief_draft", %{"belief" => "Truth matters", "domain" => "social", "conviction" => "91"}},
      {"add_belief", %{}},
      {"remove_belief", %{"index" => "0"}},
      {"update_trigger_draft", %{"topic" => "betrayal", "reaction_type" => "anger_spike", "intensity_modifier" => "77", "flavor_text" => "goes quiet"}},
      {"add_trigger", %{}},
      {"remove_trigger", %{"index" => "0"}},
      {"update_moral_line_draft", %{"principle" => "Protect the innocent"}},
      {"add_moral_line", %{}},
      {"remove_moral_line", %{"index" => "0"}},
      {"update_secret_draft", %{"secret_text" => "Hidden oath", "risk_level" => "high", "domain" => "past"}},
      {"add_secret", %{}},
      {"remove_secret", %{"index" => "0"}},
      {"update_desire_draft", %{"desire" => "Belonging", "domain" => "connection", "urgency" => "82"}},
      {"add_desire", %{}},
      {"remove_desire", %{"index" => "0"}},
      {"update_goal_draft", %{"goal" => "Find allies", "current_step" => "Listen", "priority" => "66"}},
      {"add_goal", %{}},
      {"remove_goal", %{"index" => "0"}},
      {"update_grief_draft", %{"subject" => "Old home", "loss_type" => "home", "stage" => "denial", "intensity" => "61"}},
      {"add_grief_arc", %{}},
      {"remove_grief_arc", %{"index" => "0"}},
      {"update_forgiveness_draft", %{"wound_description" => "Broken promise", "stage" => "fresh", "direction" => "healing", "intensity" => "55"}},
      {"add_forgiveness_arc", %{}},
