defmodule SovereignSoulEngine.MixProject do
  use Mix.Project

  def project do
    [
      app: :sovereign_soul_engine,
      version: "0.1.0",
      elixir: "~> 1.15",
  ...
  def application do
    [
      mod: {SovereignSoulEngine.Application, []},
  ...
  defp aliases do
    [
      ...
      coverage: ["compile", "test --cover test --no-compile"],
      ...
      "assets.build": [
        "compile",
        "tailwind sovereign_soul_engine",
        "esbuild sovereign_soul_engine"
      ],
      "assets.deploy": [
        "tailwind sovereign_soul_engine --minify",
